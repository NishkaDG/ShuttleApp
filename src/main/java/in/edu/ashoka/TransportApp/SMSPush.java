...
public class SMSPush {
    ...
    public void pushMessage(String textmessage) throws URISyntaxException {
        Twilio.init(account_sid, auth_key);
        Message message = Message.creator(new PhoneNumber("+917898214528"), new PhoneNumber("+12018627593"), textmessage).create();
    }
}
